...
describe('Gilded Rose', function () {
  ...
  it('should reduce by 1 the sell in and the quality attributes of a general item', function () {
  ...
  it('should reduce by 1 the sell in and the quality attributes of a set of general items', function () {
  ...
  it(`should increase by 1 the quality of a ${BackstagePassItemName} item after the update`, () => {
  ...
  it(`should increase the quality of a ${BackstagePassItemName} item by 2 if sell in is less than 11 and greater than 5 without going over 50`, () => {
  ...
  it(`should increase the quality of a ${BackstagePassItemName} item by 3 if sell in is less than 6 without going over 50`, () => {
  ...
  it(`should not increase the quality of a ${BackstagePassItemName} item when it is over 50`, () => {
  ...
  it(`should drop the quality of a ${BackstagePassItemName} to 0 when the concert is passed`, () => {
